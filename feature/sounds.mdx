# Add sound effects and background loops in seconds
...
2) The image sound is now available within the sounds grid, which means you can use it 
on any of the paragraphs within your article. In this section you can edit the name of the sound, associate a color to it to help visualise it within the Editor and set whether it is the default sound to use if a paragraph does not have a specific one selected.

** Image goes here **

3) Click on the side bar on nay paragraph and select which sound should be used for that paragrah.
...
2) When adding a sound, simply click on one from the Sound Grid and its added to the your story.
