...
This is easy to understand if you compare Arabic from the Emirates to Egypt, they might as well be separate languages. Or Australian English VS American.

Because of this users have the option of translating between any language and dialect, without actually having to do anything else (unless they would also like to narrate!).
...
- Translate the metadata (title / description / tags)
- Publish
