<PageTitle title="Recording User Experiences" />

The ability to provide the user detailed information about their experience is part of the [Enjamon philosophy](../company/philosophy). Within the current versions we support both capturing the users pulse and recording audio responses, with more in the works.

## Recording responses 

### Verbal Responses

<YoutubeVideoLink id="kbhQmKBOOII" />

An audio response is the ability for a user to reply to a question verbally within a document (for usecases such as [gratitude journal](../use-case/gratitude-journal) or [user research](./user-case/user-research) or to just describe what they see during something like a [shamanic journey](./use-case/shamanism)

In order to enable audio journaling, the following steps need to be taken:

* Login
* Enable audio journaling and providing the browser permission to use the microphone
...
** Caveat: Due to the application still being in it's early days we currently only support the [Viacom Oxymeter](https://www.viatomtech.com/fs20f) **
